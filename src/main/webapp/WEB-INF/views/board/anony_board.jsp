			...
			<div class="container">
				<div class="row">
					...
					<div class="container">
						...
						<div class="row">
							<c:forEach var="Go_boardDTO" items="${anonyList}" 
								varStatus="status">
									...
									<div class="p-3 border bg-light">
										<div class="post-entry-2 d-flex">
											<div class="contents order-md-1 pl-0">
												...
												<h2>
													<a href="anony_board_view?brd_num=${Go_boardDTO.brd_num}">
					...
					<div class="col-lg-6">
						<ul class="custom-pagination list-unstyled">
							<c:if test="${paging.pre}">
								<li><a href="/board/anony_board?page=${paging.start-1}"><i
								...
								<c:choose>
									<c:when test="${paging.ct.page == i}">
										<li><a style="color: black;"
											href="/board/anony_board?page=${i}"><c:out value="${i}"></c:out></a></li>
									</c:when>
									<c:otherwise>
										<li><a href="/board/anony_board?page=${i}"><c:out
													value="${i}"></c:out></a></li>
									</c:otherwise>
								</c:choose>
							...
							<c:if test="${paging.next}">
								<li><a href="/board/anony_board?page=${paging.end+1}"><i
