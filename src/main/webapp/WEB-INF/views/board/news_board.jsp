									...
									<div class="p-3 border bg-light">
										<div class="post-entry-2 d-flex">
											<div class="contents order-md-1 pl-0">
												<p class="mb-3">
													<c:out value="${gdto.com_name}"></c:out>
												</p>

												<h2>
													<a href="news_board_view?brd_cm_num=${gdto.brd_cm_num}">
														<c:out value="${gdto.brd_cm_title}"></c:out>
													</a>
												</h2>
												...
												<div class="post-meta">
													<span class="d-block"> <c:out
															value="${gdto.mem_id}"></c:out>
													</span> <span class="date-read"> <i
														class="far fa-thumbs-up"> 0
...
<!-- footer 영역 end -->
	...
	$(document).ready(function(){
		$('#context.txt').html(${gdto.brd_cm_cont});
	});
	</script>
